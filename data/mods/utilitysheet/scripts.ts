export const Scripts: ModdedBattleScriptsData = {
	init() {
		const pulseDex = [
			"Turtwig", "Grotle", "Torterra", "Chimchar", "Monferno", "Infernape", "Piplup", "Prinplup", "Empoleon", "Starly", "Staravia", "Staraptor", "Bidoof", "Bibarel", "Kricketot", "Kricketune", "Shinx", "Luxio", "Luxray", "Abra", "Kadabra", "Alakazam", "Magikarp", "Gyarados", "Budew", "Roselia", "Roserade", "Zubat", "Golbat", "Crobat", "Geodude", "Graveler", "Golem", "Onix", "Steelix", "Cranidos", "Rampardos", "Shieldon", "Bastiodon", "Machop", "Machoke", "Machamp", "Psyduck", "Golduck", "Burmy", "Wormadam", "Wormadam-Sandy", "Wormadam-Trash", "Mothim", "Wurmple", "Silcoon", "Beautifly", "Cascoon", "Dustox", "Combee", "Vespiquen", "Pachirisu", "Buizel", "Floatzel", "Cherubi", "Cherrim", "Shellos", "Gastrodon", "Heracross", "Aipom", "Ambipom", "Drifloon", "Drifblim", "Buneary", "Lopunny", "Gastly", "Haunter", "Gengar", "Misdreavus", "Mismagius", "Murkrow", "Honchkrow", "Glameow", "Purugly", "Goldeen", "Seaking", "Barboach", "Whiscash", "Chingling", "Chimecho", "Stunky", "Skuntank", "Meditite", "Medicham", "Bronzor", "Bronzong", "Ponyta", "Rapidash", "Bonsly", "Sudowoodo", "Mime Jr.", "Mr. Mime", "Happiny", "Chansey", "Blissey", "Cleffa", "Clefairy", "Clefable", "Chatot", "Pichu", "Pikachu", "Raichu", "Hoothoot", "Noctowl", "Spiritomb", "Gible", "Gabite", "Garchomp", "Munchlax", "Snorlax", "Unown", "Riolu", "Lucario", "Wooper", "Quagsire", "Wingull", "Pelipper", "Girafarig", "Hippopotas", "Hippowdon", "Azurill", "Marill", "Azumarill", "Skorupi", "Drapion", "Croagunk", "Toxicroak", "Carnivine", "Remoraid", "Octillery", "Finneon", "Lumineon", "Tentacool", "Tentacruel", "Feebas", "Milotic", "Mantyke", "Mantine", "Snover", "Abomasnow", "Sneasel", "Weavile", "Uxie", "Mesprit", "Azelf", "Dialga", "Palkia", "Manaphy", "Rotom", "Gligar", "Gliscor", "Nosepass", "Probopass", "Ralts", "Kirlia", "Gardevoir", "Gallade", "Lickitung", "Lickilicky", "Eevee", "Vaporeon", "Jolteon", "Flareon", "Espeon", "Umbreon", "Leafeon", "Glaceon", "Swablu", "Altaria", "Togepi", "Togetic", "Togekiss", "Houndour", "Houndoom", "Magnemite", "Magneton", "Magnezone", "Tangela", "Tangrowth", "Yanma", "Yanmega", "Tropius", "Rhyhorn", "Rhydon", "Rhyperior", "Duskull", "Dusclops", "Dusknoir", "Porygon", "Porygon2", "Porygon-Z", "Scyther", "Scizor", "Elekid", "Electabuzz", "Electivire", "Magby", "Magmar", "Magmortar", "Swinub", "Piloswine", "Mamoswine", "Snorunt", "Glalie", "Froslass", "Absol", "Giratina", "Heatran", "Regigigas", "Cresselia", "Phione", "Manaphy", "Darkrai", "Shaymin", "Arceus", "Geodude-Alola", "Graveler-Alola", "Golem-Alola", "Ponyta-Galar", "Rapidash-Galar", "Mr. Mime-Galar", "Raichu-Alola", "Wooper-Paldea", "Sneasel-Hisui", "Mr. Rime", "Sneasler", "Sylveon", "Kleavor", "Clodsire", "Farigiraf", "Sandy Shocks", "Flutter Mane", "Iron Valiant", "Vulpix", "Vulpix-Alola", "Ninetales", "Ninetales-Alola", "Growlithe", "Growlithe-Hisui", "Arcanine", "Arcanine-Hisui", "Darumaka", "Darumaka-Galar", "Darmanitan", "Darmanitan-Zen", "Darmanitan-Galar", "Darmanitan-Galar-Zen", "Numel", "Camerupt", "Slugma", "Magcargo", "Blacephalon", "Turtonator", "Heatran", "Phione", "Poliwag", "Poliwhirl", "Poliwrath", "Politoed", "Clamperl", "Huntail", "Gorebyss", "Luvdisc", "Wailmer", "Wailord", "Pyukumuku", "Chinchou", "Lanturn", "Shellder", "Cloyster", "Seel", "Dewgong", "Qwilfish", "Qwilfish-Hisui", "Overqwil", "Staryu", "Starmie", "Relicanth", "Basculin", "Basculin-Blue-Striped", "Basculin-White-Striped", "Basculegion", "Basculegion-F", "Frillish", "Jellicent", "Horsea", "Seadra", "Kingdra", "Carvanha", "Sharpedo", "Corphish", "Crawdaunt", "Voltorb", "Voltorb-Hisui", "Electrode", "Electrode-Hisui", "Tynamo", "Eelektrik", "Eelektross", "Toxel", "Toxtricity", "Toxtricity-Low-Key", "Helioptile", "Heliolisk", "Petilil", "Lilligant", "Lilligant-Hisui", "Shaymin", "Shaymin-Sky", "Oddish", "Gloom", "Vileplume", "Bellossom", "Skiddo", "Gogoat", "Fomantis", "Lurantis", "Shroomish", "Breloom", "Bellsprout", "Weepinbell", "Victreebel", "Exeggcute", "Exeggutor", "Exeggutor-Alola", "Cacnea", "Cacturne", "Bergmite", "Avalugg", "Avalugg-Hisui", "Regice", "Spheal", "Sealeo", "Walrein", "Smoochum", "Jynx", "Snom", "Frosmoth", "Throh", "Sawk", "Crabrawler", "Crabominable", "Pancham", "Pangoro", "Koffing", "Weezing", "Weezing-Galar", "Gulpin", "Swalot", "Salandit", "Salazzle", "Diglett", "Diglett-Alola", "Dugtrio", "Dugtrio-Alola", "Mudbray", "Mudsdale", "Silicobra", "Sandaconda", "Golett", "Golurk", "Teddiursa", "Ursaring", "Ursaluna", "Noibat", "Noivern", "Cresselia", "Necrozma", "Munna", "Musharna", "Espurr", "Meowstic", "Meowstic-F", "Rufflet", "Braviary", "Braviary-Hisui", "Hatenna", "Hattrem", "Hatterene", "Indeedee", "Indeedee-F", "Pinsir", "Volbeat", "Illumise", "Shelmet", "Accelgor", "Karrablast", "Escavalier", "Wimpod", "Golisopod", "Grubbin", "Charjabug", "Vikavolt", "Paras", "Parasect", "Spinarak", "Ariados", "Ledyba", "Ledian", "Surskit", "Masquerain", "Regirock", "Rolycoly", "Carkol", "Coalossal", "Minior", "Minior-Meteor", "Stakataka", "Carbink", "Shuppet", "Banette", "Phantump", "Trevenant", "Dhelmise", "Goomy", "Sliggoo", "Sliggoo-Hisui", "Goodra", "Goodra-Hisui", "Axew", "Fraxure", "Haxorus", "Jangmo-o", "Hakamo-o", "Kommo-o", "Dratini", "Dragonair", "Dragonite", "Zorua", "Zorua-Hisui", "Zoroark", "Zoroark-Hisui", "Darkrai", "Pawniard", "Bisharp", "Kingambit", "Rattata", "Rattata-Alola", "Raticate", "Raticate-Alola", "Registeel", "Skarmory", "Honedge", "Doublade", "Aegislash", "Aegislash-Blade", "Milcery", "Alcremie", "Regigigas", "Arceus", "Type: Null", "Silvally", "Kangaskhan", "Pidgey", "Pidgeotto", "Pidgeot", "Spearow", "Fearow", "Stantler", "Wyrdeer", "Drampa", "Cyclizar", "Fidough", "Dachsbun", "Charcadet", "Armarouge", "Ceruledge", "Nacli", "Naclstack", "Garganacl", "Glimmet", "Glimmora", "Cetoddle", "Cetitan", "Tatsugiri", "Dondozo", "Nymble", "Lokix", "Gimmighoul", "Gholdengo", "Toedscool", "Toedscruel", "Wiglett", "Wugtrio"
		];
		const pulseTms = [
