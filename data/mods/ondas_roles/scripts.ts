// This is vastly simplified, as it isn't a spreadsheet
// It's just a forum post that's trying to be a role compendium for my own reference
export const Scripts: ModdedBattleScriptsData = {
	init() {
		...
		for (const id in this.dataCache.Pokedex) {
			...
			if (!poke.kind || poke.kind !== "Ondas") continue;
